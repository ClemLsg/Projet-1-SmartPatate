...
denisx1 = pygame.mixer.Sound("denis1.wav")
denisx2 = pygame.mixer.Sound("denis2.wav")
denisx3 = pygame.mixer.Sound("denis3.wav")
...
### MODE DENIS BROGNIART

def denis():
    print("Mode Denis Brogniart active")
    while 1:
        fichierVar = open("var.txt", "r")
        touch = fichierVar.read()
        if touch == "1" and reset == 0:
